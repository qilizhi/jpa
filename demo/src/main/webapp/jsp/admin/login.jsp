...
<%--  <link href="${ctx}/static/css/custom.css" rel="stylesheet"
	type="text/css" /> 
 <link
	href="${ctx}/static/assets/global/plugins/font-awesome/css/font-awesome.min.css"
	rel="stylesheet" type="text/css" />  --%>
<link
	href="${ctx}/static/assets/global/plugins/bootstrap/css/bootstrap.min.css"
	rel="stylesheet" type="text/css" />
...
<body class=" login">
	...
	<!-- BEGIN LOGO -->
	<div class="logo">
		<a href="index.html"> <img src="${ctx}/static/img/che.png" alt=""
			width="240" height="80" />
		</a>
	</div> 
	<!-- END LOGO -->
	...
	<div class="content">
		<!-- BEGIN LOGIN FORM -->
		<form class="login-form" action="${ctx}/platformLogin"
			data-default="${returnUrl}" method="post">
			...
			<div class="form-group">
				...
				<label class="control-label visible-ie8 visible-ie9">账号</label> <input
					class="form-control form-control-solid placeholder-no-fix"
					type="text" autocomplete="off" placeholder="账号" name="username" />
			</div>
			<div class="form-group">
	...
	<div class="copyright">
		2016 © <a href="${ctx}" title="广州蕲蕲信息科技有限公司"
			target="_blank">约车管理系统</a>
	</div>
	<!--[if lt IE 9]>
...
<![endif]-->
	...
	<%--<script
		src="${ctx}/static/assets/global/plugins/bootstrap/js/bootstrap.min.js"
		type="text/javascript"></script>
	<script src="${ctx}/static/assets/global/plugins/js.cookie.min.js"
		type="text/javascript"></script> --%>
	<!-- END CORE PLUGINS -->
	<!-- BEGIN PAGE LEVEL PLUGINS -->
	<script
